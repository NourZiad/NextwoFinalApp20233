...
namespace NextwoFinalApp2023.Areas.Administrator.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public SettingsController(FinalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Settings != null ? 
                          ...
                          Problem("Entity set 'FinalDbContext.Settings'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalDbContext.Settings'  is null.");
            }
            var setting = await _context.Settings.FindAsync(id);
            if (setting != null)
            {
